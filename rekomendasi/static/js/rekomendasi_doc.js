...
function loadRekomendasi() {
    ...
    $.get("json_doc/", function (data) {
        $.each(data, function (i, value) {
            ...
            del_btn.classList.add("bg-red-400", "text-white", "rounded-lg", "pl-3", "md:pl-2", "p-2", "text-center")
            
            del_btn.innerHTML = "Hapus Rekomendasi"
            div_btn.appendChild(del_btn)
            delBtn.setAttribute("onclick", `delRekomendasi(${value.pk})`)
            harga_beli.appendChild(div_btn)
...
function delRekomendasi(pk) {
    var url = `/rekomendasi/delete/${pk}/`;
