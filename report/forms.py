...
class ReportForm(forms.Form):
    ...
    height = forms.CharField(label="Tinggi Badan Anak", required=True, widget=forms.TextInput(attrs={'placeholder': 'Contoh: 130 cm', 'class': 'form-control bg-red-100 rounded-lg h-10 pl-4 w-full', 'id': 'report-height'}))
    weight = forms.CharField(label="Berat Badan Anak", required=True, widget=forms.TextInput(attrs={'placeholder': 'Contoh: 30 kg', 'class': 'form-control bg-red-100 rounded-lg h-10 pl-4 w-full', 'id': 'report-weight'}))
