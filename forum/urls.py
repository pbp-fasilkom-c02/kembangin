...
from forum.views import add_forum, delete_comment, delete_forum, get_forums_json, handle_vote, show_forum_index, show_forum_detail,get_forum_by_pk, add_comment, delete_forum_flutter, add_comment_flutter
...
urlpatterns = [
    ...
    path('<int:pk>/add-comment-flutter',add_comment_flutter, name="add_comment_flutter"),
